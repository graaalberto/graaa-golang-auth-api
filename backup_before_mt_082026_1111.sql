...
\restrict D5ZrK8XxFoWGviXSvmdchVXgbDMZJ9bJoacexayAqtim5QbxIPGQQadqfWz6tUU
...
CREATE TABLE public.activity_logs (
    ...
    CONSTRAINT chk_activity_logs_severity CHECK ((severity = ANY (ARRAY['CRITICAL'::text, 'IMPORTANT'::text, 'INFORMATIONAL'::text])))
);
...
--
-- Name: COLUMN activity_logs.severity; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.activity_logs.severity IS 'Event severity: CRITICAL, IMPORTANT, or INFORMATIONAL';


--
-- Name: COLUMN activity_logs.expires_at; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.activity_logs.expires_at IS 'Automatic expiration timestamp for log cleanup based on retention policies';


--
-- Name: COLUMN activity_logs.is_anomaly; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.activity_logs.is_anomaly IS 'Flag indicating if this log was created due to anomaly detection';
...
--
-- Name: idx_activity_logs_cleanup; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_activity_logs_cleanup ON public.activity_logs USING btree (severity, expires_at, "timestamp");
...
--
-- Name: idx_activity_logs_expires; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_activity_logs_expires ON public.activity_logs USING btree (expires_at) WHERE (expires_at IS NOT NULL);
...
CREATE INDEX idx_activity_logs_user_timestamp ON public.activity_logs USING btree (user_id, "timestamp" DESC);
...
\unrestrict D5ZrK8XxFoWGviXSvmdchVXgbDMZJ9bJoacexayAqtim5QbxIPGQQadqfWz6tUU
